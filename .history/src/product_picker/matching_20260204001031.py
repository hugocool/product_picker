...
def _pair_repeat_counts(session: Session, folder: str, candidate_ids: List[int]) -> Dict[Tuple[int, int], int]:
...
def choose_next_pair(folder: str) -> Optional[Tuple[int, int]]:
    """
