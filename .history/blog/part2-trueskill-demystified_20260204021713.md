...
| Symbol | Name | Meaning |
|--------|------|---------|
| $\mu$ | Mean | Our best guess at the true skill |
...
That high $\sigma = 8.333$ is TrueSkill's way of saying: "I have no idea how good this pendant is. It could be anywhere from terrible to amazing."
...
*Figure 2: A single comparison updates both pendants. The winner's $\mu$ increases, the loser's decreases, and crucially—both $\sigma$ values shrink, indicating increased confidence.*
...
Another way to think about $\mu - 3\sigma$: it represents a skill level **you're almost certainly not worse than**. Out of all possible skill values your true skill could be (remember, the Gaussian bell curve extends infinitely), 99.7% of the probability mass lies above this conservative estimate. It's a pessimistic but stable number for comparison.
...
|---------|---------------|
| **Two numbers ($\mu$, $\sigma$)** | Track both skill and confidence |
...
[^4]: Moser, J. (2010). "Computing Your Skill." An excellent intuitive explanation of TrueSkill with practical implementation details. https://www.moserware.com/2010/03/computing-your-skill.html
